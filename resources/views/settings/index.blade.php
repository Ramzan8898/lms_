            ...
            <div class="lg:col-span-1">
                <div class="bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6 h-full">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        @else
                            <div
                                class="w-48 h-48 bg-white/5 border-2 border-dashed border-yellow-600/20 rounded-2xl flex items-center justify-center">
                        ...
                        <div class="p-4 bg-black/40 rounded-xl group hover:bg-pink-600/10 transition-all">
                            ...
                            @if ($settings && $settings->instagram)
                                <a href="{{ $settings->instagram }}" target="_blank"
                                    class="text-sm text-pink-400 hover:underline break-all">
                        ...
                        <div class="p-4 bg-black/40 rounded-xl group hover:bg-red-600/10 transition-all">
                            ...
                            @if ($settings && $settings->youtube)
                                <a href="{{ $settings->youtube }}" target="_blank"
                                    class="text-sm text-red-400 hover:underline break-all">
