    ...
    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6 sticky top-24">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-400 text-sm mb-2">Current Logo</label>
                            <img src="{{ asset('storage/'.$settings->logo) }}"
                                alt="Current Logo"
                                class="w-32 h-auto rounded-lg border border-yellow-600/20">
                        </div>
                        @endif
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <button type="button"
                                    ...
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linecap="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0l-4 4m4-4v12"></path>
                                    </svg>
                                    Choose Logo
                                </button>
                            </div>
                            <div id="logo-preview" class="mt-4 hidden">
                                <img src="#" alt="Logo Preview" class="w-32 h-auto rounded-lg border border-yellow-500">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gradient-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6">
                    ...
                    <div>
                        <textarea name="website_about"
                            rows="6"
                            placeholder="Write something about your website..."
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <button type="submit"
                        class="px-8 py-4 bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-semibold rounded-xl hover:shadow-lg hover:shadow-yellow-500/25 transition-all duration-300 flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
