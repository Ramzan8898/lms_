...
<aside
    class="w-80 bg-gradient-to-b from-[#0a0a0a] via-[#0f0f0f] to-black border-r border-yellow-600/20 text-white hidden md:flex flex-col relative overflow-hidden backdrop-blur-xl">
    ...
    <div class="relative flex flex-col items-center py-12 border-b border-yellow-600/20 group">
        <!-- Logo Glow Effect -->
        <div
            class="absolute -inset-10 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700">
        </div>
        ...
        <div class="relative mb-4 transform group-hover:scale-105 transition-all duration-700">
            <!-- Multi-layer Glow -->
            <div
                class="absolute -inset-4 bg-gradient-to-r from-yellow-500/30 to-orange-500/30 rounded-full blur-xl opacity-0 group-hover:opacity-60 transition-opacity duration-700">
            </div>
            <div
                class="absolute -inset-2 bg-gradient-to-r from-yellow-500/50 to-orange-500/50 rounded-full blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-700 delay-100">
            </div>
            ...
            <!-- Shine Effect -->
            <div
                class="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1500 bg-gradient-to-r from-transparent via-white/10 to-transparent skew-x-12">
            </div>
        </div>
        ...
        <h2 class="text-xl font-bold tracking-wide relative">
            <span
                class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent">LMS
                Admin</span>
        </h2>

        <!-- Role Badge -->
        <span
            class="mt-2 px-3 py-1 bg-yellow-500/10 border border-yellow-500/30 rounded-full text-xs text-yellow-400 font-medium">
            Super Admin
        </span>

        <!-- Decorative Bottom Line -->
        <div
            class="absolute bottom-0 left-1/2 -translate-x-1/2 w-16 h-0.5 bg-gradient-to-r from-transparent via-yellow-500 to-transparent">
        </div>
    </div>
    ...
    <nav class="flex-1 px-5 py-8 space-y-2 text-sm font-medium relative z-10">
        ...
        <a href="{{ route('dashboard') }}"
            ...
            <!-- Shine Effect -->
            <div
                class="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/10 to-transparent skew-x-12">
            </div>
        </a>
        ...
        <a href="{{ route('admin.students.lessons') }}"
            ...
            <svg class="w-5 h-5 text-gray-500 group-hover:text-yellow-400 transition-colors duration-500" fill="none"
            ...
            <span class="flex-1 font-medium">Student Lessons</span>
            <div
                class="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/10 to-transparent skew-x-12">
            </div>
        </a>
    ...
    <div class="relative p-6 border-t border-yellow-600/20 group">
        <!-- Background Effect -->
        <div
            class="absolute inset-0 bg-gradient-to-t from-yellow-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        </div>
        ...
        <form action="{{ route('auth.logout') }}" method="POST">
            <button type="submit"
                ...
                <!-- Background Effects -->
                <span
                    class="absolute inset-0 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-500"></span>

                <!-- Glow Effect -->
                <span
                    class="absolute -inset-1 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl blur-lg opacity-0 group-hover/btn:opacity-30 transition-opacity duration-500"></span>
                ...
                <!-- Shine Effect -->
                <span
                    class="absolute inset-0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-12"></span>
            </button>
        </form>
