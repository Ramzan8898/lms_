        ...
        <div class="relative container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
                ...
                <div class="lg:col-span-2">
                    ...
                    <p class="text-gray-400 mb-6 leading-relaxed max-w-md">Empowering learners worldwide with premium
                        courses, expert mentors, and cutting-edge technology. Start your journey today.</p>
