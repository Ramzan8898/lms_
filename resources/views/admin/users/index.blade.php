                    ...
                    <td class="p-4">
                        <div class="flex items-center gap-3">
                            <div class="relative">
                                ...
                                <span class="absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-500 rounded-full border-2 border-[#1e1e1e]"></span>
                                @endif
                            </div>
                            <div>
                                <span class="font-medium text-white">{{ $user->name }}</span>
                                @if($user->email_verified_at)
                                <span class="ml-2 px-1.5 py-0.5 bg-green-500/20 text-green-400 text-[10px] rounded-full">Verified</span>
                                @endif
                            </div>
                        </div>
                    </td>
