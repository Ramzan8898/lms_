...
@section('content')
    <div>
        ...
        <x-dashboard.breadcrumbs :items="[['label' => 'Students', 'url' => route('admin.students')], ['label' => 'Create']]" />
    </div>
    <form action="{{ route('admin.students.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-row gap-5">
        @csrf
        ...
        <div class="w-1/3 bg-linear-to-b from-[#1e1e1e] to-[#141414] border border-yellow-500/20 rounded-2xl shadow-xl p-6">
            ...
            <div class="w-full mt-4">
                ...
                <textarea name="address" rows="4" class="input"></textarea>
            </div>
