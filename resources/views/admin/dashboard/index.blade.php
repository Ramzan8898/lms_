...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="group relative">
        <div class="absolute -inset-0.5 bg-linear-to-r from-yellow-500 to-orange-500 rounded-2xl blur opacity-0 group-hover:opacity-30 transition duration-500"></div>
        <div class="relative bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6 hover:border-yellow-500/50 transition-all duration-500">
            ...
            <div class="mt-4 h-1 w-full bg-gray-800 rounded-full overflow-hidden">
                ...
                @endphp
                <div class="h-full bg-linear-to-r from-yellow-500 to-orange-500 rounded-full" style="width: {{ $userPercentage }}%"></div>
            </div>
        </div>
    </div>
    ...
    <div class="group relative">
        ...
        <div class="relative bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6 hover:border-yellow-500/50 transition-all duration-500">
            ...
            <div class="mt-4 h-1 w-full bg-gray-800 rounded-full overflow-hidden">
                ...
                @endphp
                <div class="h-full bg-linear-to-r from-yellow-500 to-orange-500 rounded-full" style="width: {{ $coursePercentage }}%"></div>
            </div>
        </div>
    </div>
    ...
    <div class="group relative">
        ...
        <div class="relative bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6 hover:border-yellow-500/50 transition-all duration-500">
            ...
            <div class="mt-4 h-1 w-full bg-gray-800 rounded-full overflow-hidden">
                ...
                @endphp
                <div class="h-full bg-linear-to-r from-yellow-500 to-orange-500 rounded-full" style="width: {{ $studentPercentage }}%"></div>
            </div>
        </div>
    </div>
    ...
    <div class="group relative">
        ...
        <div class="relative bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6 hover:border-yellow-500/50 transition-all duration-500">
            ...
            <div class="mt-4 h-1 w-full bg-gray-800 rounded-full overflow-hidden">
                ...
                @endphp
                <div class="h-full bg-linear-to-r from-yellow-500 to-orange-500 rounded-full" style="width: {{ $lessonPercentage }}%"></div>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="flex-1 flex flex-col items-center gap-2 group">
                <div class="w-[70%] relative">
                    ...
                    <div class="relative h-48 w-[70%] bg-gray-800/50 rounded-lg overflow-hidden">
                        <div class="absolute bottom-0 w-full bg-linear-to-t from-yellow-500 to-orange-500 rounded-lg transition-all duration-500 group-hover:from-yellow-400 group-hover:to-orange-400"
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="h-2 bg-gray-800 rounded-full overflow-hidden">
                    <div class="h-full bg-linear-to-r from-yellow-500 to-orange-500 rounded-full" style="width: {{ $category['percentage'] }}%"></div>
                </div>
            </div>
            @empty
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-3 group hover:bg-white/5 p-2 rounded-xl transition-all">
                <div class="w-10 h-10 rounded-full bg-linear-to-br from-yellow-500 to-orange-500 flex items-center justify-center text-white font-bold text-sm">
                    {{ $user['avatar'] }}
                </div>
                <div class="flex-1">
        ...
        <div class="space-y-4">
            ...
            <div class="group hover:bg-white/5 p-3 rounded-xl transition-all">
                ...
                <div class="h-1.5 w-full bg-gray-800 rounded-full overflow-hidden">
                    <div class="h-full bg-linear-to-r from-yellow-500 to-orange-500 rounded-full" style="width: {{ $course['progress'] }}%"></div>
                </div>
            </div>
            @empty
            <div class="text-center py-4">
    ...
    <div class="bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6">
        ...
        <div class="grid grid-cols-2 gap-3">
            <a href="{{ route('admin.courses.create') }}" class="group p-4 rounded-xl bg-white/5 hover:bg-linear-to-br hover:from-yellow-500/20 hover:to-orange-500/20 border border-yellow-600/20 hover:border-yellow-500/50 transition-all duration-500">
            ...
            <a href="{{ route('admin.instructor.create') }}" class="group p-4 rounded-xl bg-white/5 hover:bg-linear-to-br hover:from-yellow-500/20 hover:to-orange-500/20 border border-yellow-600/20 hover:border-yellow-500/50 transition-all duration-500">
                <svg class="w-6 h-6 text-yellow-400 mb-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.lessons.create') }}" class="group p-4 rounded-xl bg-white/5 hover:bg-linear-to-br hover:from-yellow-500/20 hover:to-orange-500/20 border border-yellow-600/20 hover:border-yellow-500/50 transition-all duration-500">
                <svg class="w-6 h-6 text-yellow-400 mb-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                <span class="text-xs text-white">New Lesson</span>
            </a>
            <a href="{{ route('admin.students.create') }}" class="group p-4 rounded-xl bg-white/5 hover:bg-linear-to-br hover:from-yellow-500/20 hover:to-orange-500/20 border border-yellow-600/20 hover:border-yellow-500/50 transition-all duration-500">
                <svg class="w-6 h-6 text-yellow-400 mb-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                </svg>
...
<div class="mt-8 bg-linear-to-br from-gray-900 to-black border border-yellow-600/20 rounded-2xl p-6">
