...
<body class="font-['Inter'] bg-black">
    ...
    <section class="relative bg-black overflow-hidden pt-20 pb-32">
        <div class="absolute inset-0 bg-gradient-to-br from-black via-[#1a0f00] to-black"></div>
        <div class="absolute right-0 top-1/3 w-[600px] h-[600px] bg-yellow-600/10 blur-[150px] rounded-full animate-pulse-slow"></div>
        <div class="absolute left-0 bottom-0 w-[400px] h-[400px] bg-orange-600/10 blur-[120px] rounded-full animate-pulse-slow animation-delay-2000"></div>
        <div class="absolute inset-0 opacity-20" style="background-image: radial-gradient(circle at 1px 1px, rgba(255,215,0,0.1) 1px, transparent 0); background-size: 40px 40px;"></div>

        <div class="relative container mx-auto px-4 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-16">
                <!-- Left Content -->
                <div class="text-white max-w-2xl lg:max-w-xl">
                    <div class="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-yellow-500/20 rounded-full px-5 py-2 mb-8 animate-float">
                    ...
                    <h1 class="text-5xl md:text-7xl font-bold leading-tight mb-8">
                        Learn, Grow, <br>
                        <span class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent relative inline-block">
                            Succeed with LMS
                            <svg class="absolute -bottom-4 left-0 w-full" viewBox="0 0 300 12" fill="none">
                                <path d="M2 10C50 3 150 3 298 10" stroke="url(#gradient)" stroke-width="4" stroke-linecap="round" />
                                <defs>
                    ...
                    <p class="text-gray-400 text-lg md:text-xl mb-10 leading-relaxed max-w-xl">
                        The ultimate Laravel-based Learning Management System designed to elevate your education experience with modern tools, interactive courses, and powerful features.
                    </p>
                    ...
                    <div class="flex items-center gap-8 mb-10">
                        ...
                        <div class="w-px h-10 bg-gradient-to-b from-transparent via-yellow-500/30 to-transparent"></div>
                        <div>
                    ...
                    <div class="flex flex-wrap gap-6">
                        <a href="#" class="group relative px-8 py-4 rounded-full font-semibold bg-gradient-to-r from-yellow-400 to-orange-500 text-black transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,170,0,0.5)] flex items-center space-x-2 overflow-hidden">
                            <span class="relative z-10">Get Started</span>
                            <span class="relative z-10 text-xl group-hover:translate-x-1 transition-transform">→</span>
                            <div class="absolute inset-0 bg-gradient-to-r from-yellow-300 to-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        </a>
                        <a href="#" class="group px-8 py-4 rounded-full font-semibold border-2 border-yellow-500/30 text-yellow-400 hover:bg-yellow-500 hover:text-black hover:border-yellow-500 transition-all duration-500 hover:scale-105 flex items-center space-x-2">
                ...
                <div class="relative group">
                    <div class="absolute -inset-4 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full opacity-20 group-hover:opacity-30 blur-3xl transition-all duration-700"></div>
                    <div class="relative">
                        <img src="{{ asset('/assets/images/ChatGPT Image Feb 16, 2026, 02_22_42 PM.png') }}" class="w-full max-w-2xl drop-shadow-[0_0_60px_rgba(255,170,0,0.3)] group-hover:scale-105 transition-transform duration-700">
                        <div class="absolute -bottom-6 -left-6 bg-black/60 backdrop-blur-xl border border-yellow-500/30 rounded-2xl p-4 animate-float">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-yellow-500/20 flex items-center justify-center"><span class="text-yellow-400 text-xl">📚</span></div>
                                <div>
                        ...
                        <div class="absolute -top-6 -right-6 bg-black/60 backdrop-blur-xl border border-yellow-500/30 rounded-2xl p-4 animate-float animation-delay-2000">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-yellow-500/20 flex items-center justify-center"><span class="text-yellow-400 text-xl">🏆</span></div>
                                <div>
    ...
    <section class="relative py-32 px-4 bg-black overflow-hidden">
        ...
        <div class="absolute inset-0">
            <!-- Gradient Orbs -->
            <div class="absolute top-40 right-0 w-[600px] h-[600px] bg-gradient-to-r from-yellow-500/5 via-orange-500/5 to-transparent rounded-full blur-[120px] animate-pulse-slow"></div>
            <div class="absolute bottom-40 left-0 w-[600px] h-[600px] bg-gradient-to-l from-yellow-500/5 via-orange-500/5 to-transparent rounded-full blur-[120px] animate-pulse-slow animation-delay-2000"></div>
            ...
            <div class="absolute inset-0">
                ...
                <div class="absolute top-2/3 right-1/3 w-2 h-2 bg-orange-400/30 rounded-full animate-float-slower"></div>
                <div class="absolute bottom-1/4 left-1/2 w-1.5 h-1.5 bg-yellow-500/30 rounded-full animate-float"></div>
            </div>
        </div>
        ...
        <div class="relative container mx-auto">
            ...
            <div class="text-center mb-20">
                ...
                <div class="inline-flex items-center gap-4 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 backdrop-blur-xl border border-yellow-500/30 rounded-full px-6 py-3 mb-8 relative group cursor-pointer">
                    <span class="relative flex h-3 w-3">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-yellow-400 opacity-75"></span>
                        <span class="relative inline-flex rounded-full h-3 w-3 bg-yellow-500"></span>
                    </span>
                    <span class="text-yellow-400 font-semibold tracking-wider text-sm group-hover:text-yellow-300 transition-colors">✦ POPULAR COURSES ✦</span>
                ...
                <h2 class="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
                    <span class="bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">Most</span>
                    <span class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent relative inline-block mx-4">
                        ...
                        <svg class="absolute -bottom-4 left-0 w-full" viewBox="0 0 200 8" fill="none">
                            <path d="M2 4C50 1 150 1 198 4" stroke="url(#gradient)" stroke-width="3" stroke-linecap="round" />
                            <defs>
                                <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                    <stop offset="0%" stop-color="#FBBF24" />
                                    <stop offset="50%" stop-color="#F97316" />
                    ...
                    <span class="bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">Courses</span>
                </h2>

                <!-- Description with Stats -->
                <p class="text-gray-400 max-w-2xl mx-auto text-lg md:text-xl leading-relaxed mb-10">
                    Join <span class="text-yellow-400 font-bold">50,000+</span> students learning from our most popular courses,
                ...
                <div class="flex flex-wrap justify-center gap-4 mb-12">
                    ...
                    <button class="group relative px-8 py-3 rounded-full overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 hover:border-yellow-500/50 transition-all duration-500">
                        <span class="relative text-white group-hover:text-yellow-400 transition-colors duration-500">Development</span>
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-500 to-orange-500 group-hover:w-full transition-all duration-500"></span>
                    </button>

                    <button class="group relative px-8 py-3 rounded-full overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 hover:border-yellow-500/50 transition-all duration-500">
                        <span class="relative text-white group-hover:text-yellow-400 transition-colors duration-500">Design</span>
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-500 to-orange-500 group-hover:w-full transition-all duration-500"></span>
                    </button>

                    <button class="group relative px-8 py-3 rounded-full overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 hover:border-yellow-500/50 transition-all duration-500">
                        <span class="relative text-white group-hover:text-yellow-400 transition-colors duration-500">Business</span>
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-500 to-orange-500 group-hover:w-full transition-all duration-500"></span>
                    </button>

                    <button class="group relative px-8 py-3 rounded-full overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 hover:border-yellow-500/50 transition-all duration-500">
                        <span class="relative text-white group-hover:text-yellow-400 transition-colors duration-500">Marketing</span>
                        <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-yellow-500 to-orange-500 group-hover:w-full transition-all duration-500"></span>
                    </button>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="group relative perspective-1000">
                    ...
                    <!-- Main Card -->
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden 
                        ...
                        <div class="relative h-56 overflow-hidden">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="px-4 py-2 bg-black/60 backdrop-blur-xl border border-yellow-500/30 rounded-full text-yellow-400 text-xs font-semibold
                                       group-hover:bg-gradient-to-r group-hover:from-yellow-500 group-hover:to-orange-500 group-hover:text-black
                                       transition-all duration-500">
                                    Development
                                </span>
                            </div>
                            ...
                            <!-- Rating Badge -->
                            <div class="absolute top-4 right-4 flex items-center gap-1 px-3 py-2 bg-black/60 backdrop-blur-xl border border-yellow-500/30 rounded-full">
                            ...
                            <div class="absolute bottom-4 left-4 right-4 flex justify-between items-center">
                                <div class="flex items-center gap-2">
                                    <div class="flex -space-x-2">
                                        <img src="https://randomuser.me/api/portraits/men/32.jpg" class="w-8 h-8 rounded-full border-2 border-yellow-500/50">
                                        <img src="https://randomuser.me/api/portraits/women/44.jpg" class="w-8 h-8 rounded-full border-2 border-yellow-500/50">
                                        <img src="https://randomuser.me/api/portraits/men/67.jpg" class="w-8 h-8 rounded-full border-2 border-yellow-500/50">
                                    </div>
                                    <span class="text-white text-xs">45+ enrolled</span>
                                </div>
                                <span class="px-3 py-1 bg-yellow-500 text-black text-xs font-bold rounded-full">Bestseller</span>
                            </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-3 mb-4">
                                <img src="https://randomuser.me/api/portraits/women/44.jpg" class="w-10 h-10 rounded-full border-2 border-yellow-500/50">
                                <div>
                            ...
                            <!-- Title -->
                            <h3 class="text-xl font-bold text-white mb-3 group-hover:text-yellow-400 transition-colors duration-500 line-clamp-2">
                                Full Stack Web Development Bootcamp
                            </h3>

                            <!-- Description -->
                            <p class="text-gray-400 text-sm mb-4 leading-relaxed line-clamp-2">
                                Master React, Node.js, MongoDB & more. Build 10+ real-world projects and land your dream job.
                            </p>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-white/10 group-hover:border-yellow-500/30 transition-colors duration-500">
                                <div>
                                    ...
                                    <div class="flex items-center gap-1">
                                        <span class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">$49</span>
                                ...
                                <a href="#" class="relative px-6 py-3 rounded-xl overflow-hidden group/btn">
                                    <span class="absolute inset-0 bg-gradient-to-r from-yellow-500 to-orange-500"></span>
                                    <span class="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-400 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-500"></span>
                            ...
                            <div class="absolute -top-2 -right-2 w-16 h-16">
                                <div class="absolute inset-0 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full animate-pulse"></div>
                                <div class="absolute inset-1 bg-black rounded-full flex items-center justify-center text-center">
                                    <span class="text-yellow-400 text-[10px] font-bold leading-tight">LIMITED<br>OFFER</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden 
                        ...
                        <div class="relative h-56 overflow-hidden">
                            ...
                            <div class="absolute bottom-4 left-4 right-4 flex justify-between items-center">
                                <div class="flex items-center gap-2">
                                    <div class="flex -space-x-2">
                                        <img src="https://randomuser.me/api/portraits/women/68.jpg" class="w-8 h-8 rounded-full border-2 border-yellow-500/50">
                                        <img src="https://randomuser.me/api/portraits/men/75.jpg" class="w-8 h-8 rounded-full border-2 border-yellow-500/50">
                                    </div>
                                    <span class="text-white text-xs">32+ enrolled</span>
                                </div>
                                <span class="px-3 py-1 bg-yellow-500 text-black text-xs font-bold rounded-full">Trending</span>
                            </div>
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-400 text-sm mb-4 leading-relaxed line-clamp-2">
                                Master Figma, prototyping, user research & wireframing. Create stunning interfaces that users love.
                            </p>

                            <div class="grid grid-cols-2 gap-3 mb-5">
                                <div class="flex items-center gap-2"><svg class="w-4 h-4 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linecap="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-white/10 group-hover:border-yellow-500/30 transition-colors duration-500">
                                <div>
                                    ...
                                    <div class="flex items-center gap-1">
                                        <span class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">$39</span>
                ...
                <div class="group relative perspective-1000">
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden 
                        ...
                        <div class="p-6">
                            <div class="flex items-center gap-3 mb-4">
                                <img src="https://randomuser.me/api/portraits/men/67.jpg" class="w-10 h-10 rounded-full border-2 border-yellow-500/50">
                                <div>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-white/10 group-hover:border-yellow-500/30 transition-colors duration-500">
                                <div>
                                    ...
                                    <div class="flex items-center gap-1">
                                        <span class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">$79</span>
                                        <span class="text-gray-500 text-xs">74% off</span>
                                    </div>
                                </div>
                ...
                <div class="group relative perspective-1000">
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden 
                        ...
                        <div class="p-6">
                            <div class="flex items-center gap-3 mb-4">
                                <img src="https://randomuser.me/api/portraits/women/68.jpg" class="w-10 h-10 rounded-full border-2 border-yellow-500/50">
                                <div>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-white/10 group-hover:border-yellow-500/30 transition-colors duration-500">
                                <div>
                                    ...
                                    <div class="flex items-center gap-1">
                                        <span class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">$59</span>
            ...
            <div class="text-center mt-16">
                <a href="#" class="group relative inline-flex items-center gap-4 px-10 py-5 rounded-full overflow-hidden">
                    <!-- Background with Gradient -->
                    <span class="absolute inset-0 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded-full"></span>
                    <span class="absolute inset-0 bg-gradient-to-r from-yellow-500 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full"></span>

                    <!-- Content -->
                    <span class="relative text-white group-hover:text-black transition-colors duration-500 font-semibold text-lg">View All Courses</span>
                    <span class="relative w-8 h-8 rounded-full bg-yellow-500/20 group-hover:bg-white flex items-center justify-center transition-all duration-500">
                        <span class="text-yellow-400 group-hover:text-black text-xl group-hover:translate-x-1 transition-all duration-500">→</span>
                    </span>

                    <!-- Shine Effect -->
                    <span class="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/20 to-transparent skew-x-12"></span>
                </a>
            </div>
            ...
            <div class="mt-20 grid grid-cols-3 md:grid-cols-5 gap-4">
                <div class="text-center group cursor-pointer">
                    <div class="text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-1">500+</div>
                    <div class="text-gray-500 text-xs uppercase tracking-wider">Total Courses</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-1">50K+</div>
                    <div class="text-gray-500 text-xs uppercase tracking-wider">Enrollments</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-1">150+</div>
                    <div class="text-gray-500 text-xs uppercase tracking-wider">Mentors</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-1">4.9</div>
                    <div class="text-gray-500 text-xs uppercase tracking-wider">Avg Rating</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-2xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-1">24/7</div>
    ...
    <section class="py-24 px-4 bg-gradient-to-b from-black to-[#0a0a0a]">
        <div class="container mx-auto">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <!-- Left - Image -->
                <div class="relative group">
                    <div class="absolute -inset-4 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-3xl opacity-20 group-hover:opacity-30 blur-2xl transition-all duration-700"></div>
                    <div class="relative rounded-3xl overflow-hidden border border-yellow-500/30">
                        <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" class="w-full h-auto group-hover:scale-105 transition-transform duration-700">
                        ...
                        <div class="absolute bottom-6 left-6 right-6">
                            <div class="backdrop-blur-xl bg-black/60 border border-yellow-500/30 rounded-2xl p-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="h-10 w-px bg-gradient-to-b from-transparent via-yellow-500/50 to-transparent"></div>
                                    <div>
                ...
                <!-- Right - Content -->
                <div>
                    <span class="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-yellow-500/20 rounded-full px-5 py-2 mb-6">
                        <span class="w-2 h-2 bg-yellow-400 rounded-full animate-pulse"></span>
                        <span class="text-yellow-400 font-semibold tracking-wider text-sm">ABOUT OUR LMS</span>
                    </span>
                    <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Empowering Tomorrow's <span class="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">Leaders Today</span></h2>
                    <p class="text-gray-400 text-lg leading-relaxed mb-8">Our mission is to create a modern learning environment where students can access premium courses, learn from industry experts, and track their progress easily through our cutting-edge platform.</p>

                    <div class="grid grid-cols-2 gap-6 mb-8">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-yellow-500/20 flex items-center justify-center"><span class="text-yellow-400">✓</span></div>
                            <div>
                    ...
                    <a href="#" class="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-semibold rounded-full hover:scale-105 transition-all duration-500 hover:shadow-[0_0_40px_rgba(255,170,0,0.5)]">
    ...
    <section class="relative py-32 px-4 bg-gradient-to-b from-black via-[#0a0a0a] to-black overflow-hidden">
        ...
        <div class="absolute inset-0">
            <!-- Gradient Orbs with Animation -->
            <div class="absolute top-40 left-1/4 w-[600px] h-[600px] bg-gradient-to-r from-yellow-500/5 via-orange-500/5 to-transparent rounded-full blur-[120px] animate-pulse-slow"></div>
            <div class="absolute bottom-40 right-1/4 w-[600px] h-[600px] bg-gradient-to-l from-yellow-500/5 via-orange-500/5 to-transparent rounded-full blur-[120px] animate-pulse-slow animation-delay-2000"></div>
            ...
            <div class="absolute inset-0">
                ...
                <div class="absolute bottom-1/4 left-1/2 w-1.5 h-1.5 bg-yellow-500/20 rounded-full animate-float-slower"></div>
            </div>
        </div>
        ...
        <div class="relative container mx-auto">
            ...
            <div class="text-center mb-20">
                ...
                <div class="inline-flex items-center gap-4 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 backdrop-blur-xl border border-yellow-500/30 rounded-full px-6 py-3 mb-8 relative group cursor-pointer">
                    ...
                    <span class="text-yellow-400 font-semibold tracking-wider text-sm group-hover:text-yellow-300 transition-colors">✦ STUDENT SUCCESS STORIES ✦</span>
                    <span class="bg-yellow-500/20 text-yellow-400 px-3 py-1 rounded-full text-xs font-bold">REAL REVIEWS</span>
                ...
                <!-- Main Heading with Advanced Typography -->
                <h2 class="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
                    <span class="bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">What Our</span>
                    <span class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent relative inline-block mx-4">
                        Students
                        <svg class="absolute -bottom-4 left-0 w-full" viewBox="0 0 200 8" fill="none">
                            <path d="M2 4C50 1 150 1 198 4" stroke="url(#gradient)" stroke-width="3" stroke-linecap="round" />
                    ...
                    <span class="bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">Say</span>
                </h2>

                <!-- Description with Stats -->
                <p class="text-gray-400 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed mb-10">
                    Join <span class="text-yellow-400 font-bold">50,000+</span> happy students who have transformed their careers and lives through our platform
                </p>
                ...
                <div class="flex flex-wrap justify-center gap-8 mb-12">
                    ...
                    <div class="flex items-center gap-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-6 py-3">
                        <svg class="w-6 h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linecap="round" stroke-width="2" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5"></path>
                        </svg>
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 
                        ...
                        <div class="flex items-start gap-4 mb-6">
                            <div class="relative">
                                ...
                                <div class="absolute -bottom-1 -right-1 w-6 h-6 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full flex items-center justify-center">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="text-xl font-bold text-white group-hover:text-yellow-400 transition-colors">Sarah Johnson</h4>
                                    <span class="px-2 py-0.5 bg-blue-500/20 text-blue-400 text-xs rounded-full">Verified</span>
                                </div>
                        ...
                        <div class="relative">
                            <p class="text-gray-300 leading-relaxed mb-4 relative z-10">
                                "This platform completely transformed my career. The courses are well-structured and the mentors are incredibly supportive. Landed my dream job at Google within 3 months of completing the Full Stack program!"
                            </p>

                            <!-- Achievement Tags -->
                            <div class="flex flex-wrap gap-2 mt-4">
                                <span class="px-3 py-1 bg-yellow-500/10 border border-yellow-500/30 rounded-full text-yellow-400 text-xs">🎓 Full Stack Graduate</span>
                                <span class="px-3 py-1 bg-green-500/10 border border-green-500/30 rounded-full text-green-400 text-xs">💼 Placed at Google</span>
                                <span class="px-3 py-1 bg-purple-500/10 border border-purple-500/30 rounded-full text-purple-400 text-xs">⭐ Top Performer</span>
                            </div>
                        ...
                        <div class="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            <span class="text-yellow-400 text-sm flex items-center gap-1">
                                Read Full Story <span class="text-lg group-hover:translate-x-1 transition-transform">→</span>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 
                        ...
                        <div class="relative mb-6 rounded-xl overflow-hidden cursor-pointer group/video">
                            ...
                            <div class="absolute inset-0 bg-black/50 flex items-center justify-center">
                                <div class="w-12 h-12 rounded-full bg-gradient-to-r from-yellow-500 to-orange-500 flex items-center justify-center group-hover/video:scale-110 transition-transform duration-300">
                                    <span class="text-black text-2xl">▶</span>
                                </div>
                            </div>
                            <span class="absolute bottom-2 right-2 px-2 py-1 bg-black/60 text-white text-xs rounded">2:34</span>
                        </div>
                        ...
                        <div class="flex items-start gap-4 mb-6">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="text-xl font-bold text-white group-hover:text-yellow-400 transition-colors">Michael Chen</h4>
                                    <span class="px-2 py-0.5 bg-blue-500/20 text-blue-400 text-xs rounded-full">Verified</span>
                                </div>
                                <p class="text-gray-400 text-sm mb-2">Data Scientist at OpenAI</p>
                                <div class="flex gap-1 text-yellow-400">★★★★★ <span class="text-gray-400 text-sm ml-2">5.0</span></div>
                            </div>
                        </div>

                        <div class="relative">
                            <p class="text-gray-300 leading-relaxed mb-4">
                                "The data science track is outstanding. Real-world projects and expert guidance helped me switch careers smoothly. Best investment I ever made! Now leading AI projects at OpenAI."
                            </p>

                            <div class="flex flex-wrap gap-2 mt-4">
                                <span class="px-3 py-1 bg-yellow-500/10 border border-yellow-500/30 rounded-full text-yellow-400 text-xs">🤖 AI Graduate</span>
                                <span class="px-3 py-1 bg-green-500/10 border border-green-500/30 rounded-full text-green-400 text-xs">💼 Placed at OpenAI</span>
                                <span class="px-3 py-1 bg-purple-500/10 border border-purple-500/30 rounded-full text-purple-400 text-xs">📊 4 Projects</span>
                            </div>
                ...
                <div class="group relative perspective-1000">
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 
                        ...
                        <div class="flex items-start gap-4 mb-6">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="text-xl font-bold text-white group-hover:text-yellow-400 transition-colors">Priya Patel</h4>
                                    <span class="px-2 py-0.5 bg-blue-500/20 text-blue-400 text-xs rounded-full">Verified</span>
                                    <span class="px-2 py-0.5 bg-yellow-500/20 text-yellow-400 text-xs rounded-full">Featured</span>
                                </div>
                        ...
                        <div class="relative">
                            <p class="text-gray-300 leading-relaxed mb-4">
                                "The UI/UX course exceeded my expectations. The portfolio projects and feedback from mentors helped me get multiple job offers. Within 6 months, I went from junior to lead designer at Adobe!"
                            </p>

                            <!-- Portfolio Preview -->
                            <div class="grid grid-cols-3 gap-2 mt-4 mb-4">
                                <div class="relative rounded-lg overflow-hidden group/portfolio">
                                    <img src="https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="w-full h-16 object-cover">
                                    <div class="absolute inset-0 bg-gradient-to-r from-yellow-500/50 to-orange-500/50 opacity-0 group-hover/portfolio:opacity-100 transition-opacity"></div>
                                </div>
                                <div class="relative rounded-lg overflow-hidden group/portfolio">
                                    <img src="https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="w-full h-16 object-cover">
                                    <div class="absolute inset-0 bg-gradient-to-r from-yellow-500/50 to-orange-500/50 opacity-0 group-hover/portfolio:opacity-100 transition-opacity"></div>
                            ...
                            <div class="flex flex-wrap gap-2 mt-2">
                                <span class="px-3 py-1 bg-yellow-500/10 border border-yellow-500/30 rounded-full text-yellow-400 text-xs">🎨 UI/UX Graduate</span>
                                <span class="px-3 py-1 bg-green-500/10 border border-green-500/30 rounded-full text-green-400 text-xs">💼 Placed at Adobe</span>
                                <span class="px-3 py-1 bg-purple-500/10 border border-purple-500/30 rounded-full text-purple-400 text-xs">🌟 5 Projects</span>
                            </div>
                        ...
                        <div class="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            <span class="text-yellow-400 text-sm flex items-center gap-1">
                                View Portfolio <span class="text-lg group-hover:translate-x-1 transition-transform">→</span>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <section class="relative py-32 px-4 bg-gradient-to-b from-black via-[#0a0a0a] to-black overflow-hidden">
        ...
        <div class="absolute inset-0">
            <!-- Gradient Orbs with Animation -->
            <div class="absolute top-40 left-1/4 w-[800px] h-[800px] bg-gradient-to-r from-yellow-500/5 via-orange-500/5 to-transparent rounded-full blur-[150px] animate-pulse-slow"></div>
            <div class="absolute bottom-40 right-1/4 w-[800px] h-[800px] bg-gradient-to-l from-yellow-500/5 via-orange-500/5 to-transparent rounded-full blur-[150px] animate-pulse-slow animation-delay-2000"></div>

            <!-- Animated Particle Field -->
            <div class="absolute inset-0">
                <div class="absolute top-1/3 left-1/4 w-1 h-1 bg-yellow-400/30 rounded-full animate-float"></div>
                <div class="absolute top-2/3 right-1/3 w-2 h-2 bg-orange-400/30 rounded-full animate-float-slow"></div>
                <div class="absolute bottom-1/4 left-1/2 w-1.5 h-1.5 bg-yellow-500/30 rounded-full animate-float-slower"></div>
                <div class="absolute top-1/2 left-1/3 w-1 h-1 bg-yellow-300/30 rounded-full animate-float animation-delay-1000"></div>
                <div class="absolute top-1/4 right-1/4 w-2 h-2 bg-orange-300/30 rounded-full animate-float-slow animation-delay-2000"></div>
            </div>
        ...
        <div class="container mx-auto">
            ...
            <div class="relative max-w-6xl mx-auto">
                <!-- Premium Glow Effect -->
                <div class="absolute -inset-1 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-3xl opacity-20 blur-2xl animate-pulse-slow"></div>
                <div class="absolute -inset-2 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-3xl opacity-10 blur-3xl"></div>

                <!-- Main Content Card -->
                <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <!-- Floating Elements -->
                    <div class="absolute top-10 left-10 w-32 h-32 bg-yellow-500/10 rounded-full blur-3xl animate-float"></div>
                    <div class="absolute bottom-10 right-10 w-40 h-40 bg-orange-500/10 rounded-full blur-3xl animate-float animation-delay-2000"></div>

                    <!-- Content -->
                    <div class="relative py-20 px-8 md:px-20 text-center z-10">

                        <!-- Limited Time Offer Badge -->
                        <div class="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-xl border border-yellow-500/30 rounded-full px-6 py-3 mb-8 relative group cursor-pointer">
                            <span class="relative flex h-3 w-3">
                                <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                                <span class="relative inline-flex rounded-full h-3 w-3 bg-red-500"></span>
                            </span>
                            <span class="text-yellow-400 font-semibold tracking-wider text-sm">⚡ LIMITED TIME OFFER ⚡</span>
                            <span class="bg-red-500/20 text-red-400 px-3 py-1 rounded-full text-xs font-bold animate-pulse">HURRY!</span>
                        ...
                        <h2 class="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
                            <span class="bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent">Ready to</span>
                            <span class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent relative inline-block mx-4">
                                Transform
                                <svg class="absolute -bottom-4 left-0 w-full" viewBox="0 0 200 8" fill="none">
                                    <path d="M2 4C50 1 150 1 198 4" stroke="url(#gradient)" stroke-width="3" stroke-linecap="round" />
                            ...
                            <span class="bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent block mt-2">Your Future?</span>
                        </h2>

                        <!-- Description with Highlights -->
                        <p class="text-gray-400 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed mb-10">
                            Join <span class="text-yellow-400 font-bold">50,000+</span> students already learning on our platform.
                        ...
                        <div class="flex justify-center items-center gap-6 mb-12">
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">02</div>
                                <div class="text-gray-500 text-xs uppercase tracking-wider">Days</div>
                            </div>
                            <div class="text-4xl text-yellow-500">:</div>
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">23</div>
                                <div class="text-gray-500 text-xs uppercase tracking-wider">Hours</div>
                            </div>
                            <div class="text-4xl text-yellow-500">:</div>
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">59</div>
                                <div class="text-gray-500 text-xs uppercase tracking-wider">Mins</div>
                            </div>
                            <div class="text-4xl text-yellow-500">:</div>
                            <div class="text-center">
                                <div class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">45</div>
                        ...
                        <div class="flex flex-wrap gap-6 justify-center mb-12">
                            ...
                            <a href="#" class="group relative px-10 py-5 rounded-full overflow-hidden">
                                <!-- Background with Gradient -->
                                <span class="absolute inset-0 bg-gradient-to-r from-yellow-400 to-orange-500"></span>
                                <span class="absolute inset-0 bg-gradient-to-r from-yellow-300 to-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
                                ...
                                <!-- Tooltip -->
                                <span class="absolute -top-12 left-1/2 -translate-x-1/2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
                            ...
                            <!-- Secondary CTA -->
                            <a href="#" class="group relative px-10 py-5 rounded-full overflow-hidden border-2 border-yellow-500/30 hover:border-yellow-500 transition-all duration-500">
                                <span class="absolute inset-0 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
                                <span class="relative text-yellow-400 group-hover:text-yellow-300 font-bold text-lg flex items-center gap-3">
                        ...
                        <div class="mt-12 pt-8 border-t border-white/10">
                            <div class="flex flex-wrap justify-center items-center gap-8">
                                ...
                                <div class="flex -space-x-3">
                                    <img src="https://randomuser.me/api/portraits/women/44.jpg" class="w-10 h-10 rounded-full border-2 border-yellow-500/50 hover:scale-110 transition-transform">
                                    <img src="https://randomuser.me/api/portraits/men/32.jpg" class="w-10 h-10 rounded-full border-2 border-yellow-500/50 hover:scale-110 transition-transform">
                                    <img src="https://randomuser.me/api/portraits/women/68.jpg" class="w-10 h-10 rounded-full border-2 border-yellow-500/50 hover:scale-110 transition-transform">
                                    <img src="https://randomuser.me/api/portraits/men/75.jpg" class="w-10 h-10 rounded-full border-2 border-yellow-500/50 hover:scale-110 transition-transform">
                                    <div class="w-10 h-10 rounded-full bg-gradient-to-r from-yellow-500 to-orange-500 flex items-center justify-center text-black font-bold text-sm border-2 border-yellow-500/50">2k+</div>
                                </div>
                                <div class="text-left">
                                    <div class="flex items-center gap-2">
                                        <span class="text-yellow-400">★★★★★</span>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 max-w-4xl mx-auto">
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">50K+</div>
                    <div class="text-gray-500 text-sm uppercase tracking-wider">Active Students</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">500+</div>
                    <div class="text-gray-500 text-sm uppercase tracking-wider">Premium Courses</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">98%</div>
                    <div class="text-gray-500 text-sm uppercase tracking-wider">Success Rate</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">24/7</div>
    ...
    <footer class="relative bg-black border-t border-white/10 pt-20 pb-10 overflow-hidden">
        <!-- Background Elements -->
        <div class="absolute inset-0 bg-gradient-to-b from-black to-[#0a0a0a]"></div>
        ...
        <div class="relative container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
                ...
                <div class="lg:col-span-2">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center">
                            <span class="text-black text-2xl font-bold">LMS</span>
                        </div>
                        <span class="text-2xl font-bold text-white">Learn<span class="text-yellow-500">Master</span></span>
                    </div>
                    <p class="text-gray-400 mb-6 leading-relaxed max-w-md">Empowering learners worldwide with premium courses, expert mentors, and cutting-edge technology. Start your journey today.</p>
                    <div class="flex items-center gap-4">
                        <a href="#" class="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-gradient-to-r hover:from-yellow-500 hover:to-orange-500 hover:text-black transition-all duration-300 group">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-yellow-400 transition-colors">Courses</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-yellow-400 transition-colors">Instructors</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-gray-400 hover:text-yellow-400 transition-colors">Help Center</a></li>
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-yellow-400 transition-colors">Cookie Policy</a></li>
                    </ul>
                </div>
            ...
            <div class="relative pt-8 border-t border-white/10">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-gray-500 text-sm">© 2026 LearnMaster LMS. All rights reserved. Made with ❤️ for learners worldwide</p>
                    <div class="flex items-center gap-4">
                        <img src="https://images.unsplash.com/photo-1614064641938-3bbee52942c7?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" class="h-8 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all">
                        <img src="https://images.unsplash.com/photo-1614064641938-3bbee52942c7?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" class="h-8 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all">
                        <img src="https://images.unsplash.com/photo-1614064641938-3bbee52942c7?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" class="h-8 opacity-50 grayscale hover:grayscale-0 hover:opacity-100 transition-all">
                    </div>
                </div>
