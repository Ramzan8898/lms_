...
@section('content')
    ...
    <section class="relative py-25 bg-black/90 overflow-hidden">
        ...
        <div class="relative container mx-auto z-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-400 max-w-4xl mx-auto text-lg md:text-xl leading-relaxed relative mb-6">
    ...
    <section class="relative py-25 bg-black overflow-hidden">
        ...
        <div class="relative container mx-auto">
            ...
            <div class="text-center mb-20">
                ...
                <p class="text-gray-400 max-w-2xl mx-auto text-lg md:text-xl leading-relaxed mb-10">
                    Join <span class="text-yellow-400 font-bold">{{ number_format($totalStudents ?? 50000) }}+</span>
                    students learning from our most popular
                    courses,
                    rated <span class="text-yellow-400 font-bold">{{ $averageRating ?? 4.9 }}/5</span> by the community
                </p>
    ...
    @endforeach
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 courses-grid">
                @forelse($courses as $course)
                    <div class="group relative perspective-1000 course-card"
                        data-category="{{ $course->category->slug ?? strtolower($course->category) }}">
                        <!-- 3D Glow Effect -->
                        <div
                        ...
                        group-hover:scale-105 group-hover:-translate-y-2">
                            ...
                            <div class="relative h-56 overflow-hidden">
                                ...
                                <div
                                    class="absolute top-45 left-4 flex items-center gap-1 px-3 py-2 bg-black/60 backdrop-blur-xl border border-yellow-500/30 rounded-full">
                                ...
                                <div
                                    class="absolute top-45 right-4 flex items-center gap-1 px-3 py-2 bg-black/60 backdrop-blur-xl border border-yellow-500/30 rounded-full">
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4 text-yellow-500" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linecap="round" stroke-width="2"
                                        ...
                                        <span class="text-gray-300 text-xs">{{ number_format($course->enrolled_count) }}
                                            Students</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                <div class="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <h4 class="text-white font-semibold text-sm uppercase">
                                            {{ $course->instructor->user->name }}</h4>
                                        <p class="text-gray-400 text-xs ">{{ $course->instructor->qualification }}</p>
                                    </div>
                                </div>

                                <h3
                                    class="text-xl font-normal text-yellow-400 mb-3 group-hover:text-yellow-400 transition-colors duration-500 line-clamp-2">
                                ...
                                <div class="grid grid-cols-2 gap-3 mb-5">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span
                                            class="text-gray-300 text-xs">{{ $course->has_certificate ? 'Certificate' : 'No Certificate' }}</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4 text-yellow-500" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-1">
                                        <span
                                            class="text-3xl font-bold bg-linear-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">{{ $course->price }}$</span>
                                    </div>
    ...
    <section class="py-25 bg-black/95">
    ...
    <section class="relative py-25 bg-black">
    ...
    <section class="relative py-32 px-4 bg-black/95">
                ...
                <div
                    ...
                    <div class="relative py-20 px-8 md:px-20 text-center z-10">
                        ...
                        <div class="flex flex-wrap gap-6 justify-center mb-12">
                            <!-- Primary CTA -->
                            <a href="{{ route('web.register') }}"
                                class="group relative px-10 py-5 rounded-full overflow-hidden">
                                <!-- Background with Gradient -->
