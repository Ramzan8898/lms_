    ...
    <div class="relative container mx-auto">
        ...
        <div class="text-center mb-20">
            ...
            <p class="text-gray-400 max-w-2xl mx-auto text-lg md:text-xl leading-relaxed mb-10">
                Join <span class="text-yellow-400 font-bold">{{ number_format($totalStudents ?? 50000) }}+</span> students learning from our most popular
                courses,
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 courses-grid">
            ...
            <div class="group relative perspective-1000 course-card" data-category="{{ $course->category->slug ?? strtolower($course->category) }}">
                <!-- 3D Glow Effect -->
                <div
