...
<body class="font-['Inter']">
    ...
    <section class="relative py-32 px-6 md:px-16 bg-black text-white overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-black via-[#0f0f0f] to-black"></div>

        <!-- Premium Gradient Orbs -->
        <div class="absolute top-20 left-1/4 w-96 h-96 bg-yellow-500/10 rounded-full blur-[120px] animate-pulse"></div>
        <div class="absolute bottom-20 right-1/4 w-80 h-80 bg-orange-500/10 rounded-full blur-[120px] animate-pulse animation-delay-2000"></div>
        ...
        <div class="relative max-w-7xl mx-auto">
            ...
            <div class="text-center mb-20">
                <span class="inline-block px-4 py-2 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 text-sm font-semibold tracking-wider mb-6 backdrop-blur-sm">
                    ✦ ABOUT OUR PLATFORM ✦
                </span>
                ...
                <h1 class="text-5xl md:text-7xl font-bold mb-8 tracking-tight">
                    ...
                    <span class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent relative inline-block">
                        Digital Learning
                        <svg class="absolute -bottom-4 left-0 w-full" viewBox="0 0 300 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative group">
                    <!-- Decorative Elements -->
                    <div class="absolute -inset-4 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-3xl opacity-20 group-hover:opacity-30 blur-xl transition-all duration-700"></div>
                    <div class="absolute -inset-1 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-3xl opacity-30 group-hover:opacity-40 blur-md transition-all duration-700"></div>
                    ...
                    <div class="relative rounded-3xl overflow-hidden border border-yellow-500/30 backdrop-blur-sm">
                        ...
                        <div class="absolute bottom-6 left-6 right-6 md:bottom-8 md:left-8 md:right-8">
                            <div class="backdrop-blur-xl bg-black/40 border border-yellow-500/30 rounded-2xl p-5 transform translate-y-0 group-hover:translate-y-[-4px] transition-all duration-500">
                ...
                <div class="space-y-8">
                    <!-- Section Badge -->
                    <div class="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-5 py-2.5">
                    ...
                    <h2 class="text-4xl md:text-5xl font-bold leading-tight">
                        ...
                        <span class="bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 bg-clip-text text-transparent block mt-2">
                            Leaders Today
                        </span>
                    </h2>
                    ...
                    <ul class="space-y-5">
                        <li class="flex items-start space-x-4 group cursor-pointer">
                            <div class="w-7 h-7 rounded-full bg-gradient-to-r from-yellow-500 to-orange-500 flex items-center justify-center flex-shrink-0 mt-1 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="flex flex-wrap gap-5 pt-5">
                        <a href="#"
                            class="group relative px-8 py-4 rounded-2xl bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-semibold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,170,0,0.5)]">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 pt-12 border-t border-white/10">
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">500+</div>
                    <div class="text-gray-400 text-sm uppercase tracking-wider">Premium Courses</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">50K+</div>
                    <div class="text-gray-400 text-sm uppercase tracking-wider">Active Students</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">150+</div>
                    <div class="text-gray-400 text-sm uppercase tracking-wider">Expert Mentors</div>
                </div>
                <div class="text-center group cursor-pointer">
                    <div class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-2">98%</div>
