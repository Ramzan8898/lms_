...
<body class="font-['Inter']">
    ...
    <section class="relative py-32 px-6 md:px-16 bg-black text-white overflow-hidden">
        ...
        <div class="absolute bottom-20 right-1/4 w-80 h-80 bg-orange-500/5 rounded-full blur-[120px] animate-pulse-slow animation-delay-2000"></div>
        ...
        <div class="relative max-w-7xl mx-auto">
            ...
            <div class="text-center mb-20">
                ...
                <!-- Main Heading with Gradient and Decorative Elements -->
                <h1 class="text-5xl md:text-7xl font-bold mb-8 tracking-tight">
                    <span class="bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Let's</span>
                    <span class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent"> Connect</span>
                </h1>
            ...
            <div class="grid lg:grid-cols-3 gap-8 items-start">
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="group relative">
                        ...
                        <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-yellow-500/30 transition-all duration-500">
                            <div class="flex items-start space-x-4">
                                <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-yellow-500/20 to-orange-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+1234567890" class="text-yellow-400 hover:text-yellow-300 transition-colors text-lg font-semibold">+1 (234) 567-890</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-yellow-500/30 transition-all duration-500">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:support@lms.com" class="text-yellow-400 hover:text-yellow-300 transition-colors text-lg font-semibold">support@lms.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-yellow-500/30 transition-all duration-500">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-white text-lg">San Francisco, CA</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:col-span-2">
                    <div class="group relative">
                        <!-- Glow Effect -->
                        <div class="absolute -inset-1 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-3xl opacity-20 group-hover:opacity-30 blur-2xl transition-all duration-700"></div>

                        <!-- Form Container with Premium Styling -->
                        <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10 hover:border-yellow-500/30 transition-all duration-500">
                            ...
                            <form method="POST" action="#" class="space-y-6">
                                ...
                                <div class="pt-4">
                                    <button type="submit"
                                        class="group relative w-full px-8 py-5 bg-gradient-to-r from-yellow-500 to-orange-500 
                                        ...
                                        <span class="relative z-10 text-xl group-hover:translate-x-2 transition-transform">→</span>
                                ...
                                <!-- Trust Badge -->
                                <p class="text-center text-gray-500 text-sm mt-6 flex items-center justify-center space-x-2">
            ...
            <div class="mt-20">
                <div class="group relative">
                    <div class="absolute -inset-1 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-3xl opacity-20 group-hover:opacity-30 blur-2xl transition-all duration-700"></div>
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden h-80 hover:border-yellow-500/30 transition-all duration-500">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100940.14245968247!2d-122.43759999999999!3d37.7577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1644262073400!5m2!1sen!2sus"
                            width="100%"
                            height="100%"
                            style="border:0;"
                            allowfullscreen=""
                        ...
                        <div class="absolute inset-0 pointer-events-none bg-gradient-to-t from-black/50 via-transparent to-transparent"></div>

                        <!-- Map Badge -->
                        <div class="absolute bottom-6 left-6 bg-black/60 backdrop-blur-xl border border-yellow-500/30 rounded-xl px-6 py-3">
                            <p class="text-white font-semibold">Visit Our Campus</p>
                            <p class="text-gray-400 text-sm">San Francisco, CA</p>
                        </div>
                    </div>
                </div>
            </div>
