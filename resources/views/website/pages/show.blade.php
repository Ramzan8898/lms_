                        ...
                        <div
                            ...
                            @auth
                                ...
                                @else
                                    ...
                                    <a href="#"
                                        class="block w-full py-4 bg-white/5 border border-white/10 text-white font-bold text-center rounded-xl hover:bg-white/10 transition-all duration-500 flex items-center justify-center gap-2">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
                        ...
                        <div
                                ...
                                @forelse($course->lessons as $index => $lesson)
                                    <div class="p-4 hover:bg-white/5 transition-colors group">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div
                                                class="w-8 h-8 rounded-full bg-yellow-500/20 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-yellow-500/30 transition-colors">
                                                <span
                            ...
                            @if ($course->lessons->count() > 5)
                                <div class="p-4 border-t border-white/10">
                                    <button
                                        class="w-full py-2 text-center text-yellow-400 hover:text-yellow-300 text-sm font-semibold transition-colors">
                                        View All Lessons →
                                    </button>
                                </div>
                            @endif
                            ...
                            <div
                                ...
                                @foreach ($relatedCourses as $related)
                                    <a href="{{ route('website.pages.show', $related->slug) }}"
                                        ...
                                        <img src="{{ $related->banner ? asset($related->banner) : 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=800&q=80' }}"
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="flex items-center gap-2 mt-1">
                                                ...
                                                <span class="text-gray-400 text-xs">{{ $related->lessons->count() }}
                                                    lessons</span>
                                            </div>
                                        </div>
                                    </a>
