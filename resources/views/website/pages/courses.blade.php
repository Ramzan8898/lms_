...
<body class="font-['Inter']">
    ...
    <section class="relative py-32 px-6 md:px-16 bg-black overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-br from-black via-[#0a0a0a] to-black"></div>

        <!-- Animated Gradient Orbs -->
        <div class="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-br from-yellow-500/5 via-orange-500/5 to-transparent rounded-full blur-[120px] animate-pulse-slow"></div>
        <div class="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-orange-500/5 via-yellow-500/5 to-transparent rounded-full blur-[120px] animate-pulse-slow animation-delay-2000"></div>
        ...
        <div class="relative max-w-7xl mx-auto">
            ...
            <div class="text-center mb-20">
                <!-- Floating Badge -->
                <div class="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-yellow-500/20 rounded-full px-6 py-2 mb-8 animate-float">
                ...
                <h2 class="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
                    <span class="bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Start</span>
                    <span class="bg-gradient-to-r from-yellow-400 via-orange-500 to-yellow-600 bg-clip-text text-transparent"> Learning</span>
                    <br class="hidden md:block">
                    <span class="bg-gradient-to-r from-gray-400 to-white bg-clip-text text-transparent">Today</span>
                </h2>

                <!-- Decorative Line -->
                <div class="flex justify-center items-center space-x-4 mb-8">
                    <div class="w-12 h-0.5 bg-gradient-to-r from-transparent via-yellow-500 to-transparent"></div>
                ...
                <div class="flex flex-wrap justify-center gap-4 mt-12">
                    <button class="px-8 py-3 rounded-full bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-semibold hover:scale-105 transition-transform duration-300 shadow-lg shadow-yellow-500/20">
                        All Courses
                    </button>
                    <button class="px-8 py-3 rounded-full border border-white/10 text-white/70 hover:text-yellow-400 hover:border-yellow-500/50 backdrop-blur-sm transition-all duration-300">
                        Development
                    </button>
                    <button class="px-8 py-3 rounded-full border border-white/10 text-white/70 hover:text-yellow-400 hover:border-yellow-500/50 backdrop-blur-sm transition-all duration-300">
                        Design
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group relative">
                    ...
                    <!-- Main Card -->
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:border-yellow-500/30">
                        ...
                        <div class="relative h-56 overflow-hidden">
                            ...
                            <!-- Category Badge -->
                            <span class="absolute top-4 left-4 px-4 py-1.5 bg-black/60 backdrop-blur-sm border border-yellow-500/30 rounded-full text-yellow-400 text-sm font-semibold">
                                Development
                            </span>

                            <!-- Rating Badge -->
                            <div class="absolute top-4 right-4 flex items-center space-x-1 px-3 py-1.5 bg-black/60 backdrop-blur-sm rounded-full">
                            ...
                            <div class="absolute bottom-4 left-4 flex items-center space-x-2">
                                <span class="px-3 py-1 bg-black/60 backdrop-blur-sm rounded-full text-gray-300 text-xs flex items-center">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed mb-6 line-clamp-2">
                                Master modern web development with React, Node.js, and MongoDB. Build real-world applications and learn industry best practices.
                            </p>
                            ...
                            <div class="flex items-center space-x-3">
                                <a href="#"
                                    class="flex-1 px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-semibold rounded-xl hover:scale-105 transition-transform duration-300 text-center shadow-lg shadow-yellow-500/20">
                                    Enroll Now
                                </a>
                                <button class="p-3 border border-white/10 rounded-xl hover:border-yellow-500/50 hover:text-yellow-400 transition-all duration-300">
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:border-yellow-500/30">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed mb-6 line-clamp-2">
                                Learn user-centered design principles, wireframing, prototyping, and Figma. Create stunning interfaces that users love.
                            </p>
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:-translate-y-2 transition-all duration-500 hover:border-yellow-500/30">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-400 text-sm leading-relaxed mb-6 line-clamp-2">
                                Master Python, Machine Learning, and AI algorithms. Work with real datasets and build predictive models.
                            </p>
            ...
            <div class="text-center mt-16">
                <a href="#"
                    class="inline-flex items-center space-x-3 px-10 py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full text-white font-semibold hover:bg-gradient-to-r hover:from-yellow-500 hover:to-orange-500 hover:text-black hover:border-transparent transition-all duration-500 group">
