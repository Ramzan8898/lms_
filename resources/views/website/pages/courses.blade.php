            ...
            <section class="relative   overflow-hidden">
                ...
                <div class="absolute inset-0">
                 ...
                 background-size: 40px 40px, 100% 100%;">
                    ...
                    <!-- Floating Particles -->
                    <div class="absolute inset-0">
                        <div class="absolute top-1/3 left-1/4 w-1 h-1 bg-yellow-400/30 rounded-full animate-float-slow">
                        </div>
                ...
                <div class="relative container mx-auto">
                    ...
                    <div class="text-center ">
                        ...
                        <div class="flex flex-wrap justify-center gap-4 mb-12">
                            <button class="category-filter px-8 py-3 rounded-full border transition-all duration-300"
                                data-category="all">
                                All Courses
                            </button>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 courses-grid py-4">
                        @forelse($courses as $course)
                            <div class="group relative perspective-1000 course-card"
                                data-category="{{ $course->category->title ?? strtolower($course->category) }}">
                                <!-- 3D Glow Effect -->
                                <div
                                   ...
                                   transition-all duration-500">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span
                                                    class="text-gray-300 text-xs">{{ number_format($course->enrolled_count) }}
                                                    Students</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-6">
                                        <div class="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-400 text-xs ">{{ $course->instructor->qualification }}
                                                </p>
                                            </div>
                                        </div>
